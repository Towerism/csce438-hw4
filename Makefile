...
CLIENT_FILES = fbc.cc arguments_parser.cc fb_client.cc command_stream.cc join_command.cc list_command.cc command_factory.cc
...
FILES = $(CLIENT_FILES) $(SERVER_FILES) $(PROTO_SOURCE_FILES)

# Directory names
CLIENT_DIR = client
SERVER_DIR = server
PROTO_DIR = protocol
DIRS = $(CLIENT_DIR) $(SERVER_DIR) $(PROTO_DIR)
...
CLEAN = $(CLIENT) $(SERVER) $(OBJECTS_DIR) $(PROTO_DIR)/*.cc $(PROTO_DIR)/*.h
